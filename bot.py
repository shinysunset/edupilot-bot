...
class CognitiveBoundaryManager:
    ...
    "а не дать готовый ответ. Отвечай ТОЛЬКО на русском языке. Никаких английских слов и фраз. Будь лаконичен."
    ...
    "ВАЖНО: никогда не соглашайся с ответом студента автоматически. "
